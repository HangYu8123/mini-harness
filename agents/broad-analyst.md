---
name: broad-analyst
description: "mini-harness worker — spawned by the mini-harness protocol in addition to the platform's own subagents; never by autonomous delegation. Analyzes code by following the pipeline from upstream to downstream, reading every script in order for full coverage."
